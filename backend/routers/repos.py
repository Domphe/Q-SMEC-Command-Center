...
REPO_REGISTRY = [
    {
        ...
        "domain": "ENGINE",
        "folder": "Q-SMEC-Orchestration-Engine",
        "desc": "Pipeline orchestration, PLAYBOOK.md v3.2.0",
    },
    {
        "name": "Orchestration-Docs",
        "domain": "DOCS",
        "folder": "Q-SMEC-Orchestration-Docs",
        "desc": "ECOSYSTEM_REGISTRY, ops tracker, reports",
    },
    {
        "name": "NIKET-Q-SMEC-Product",
        "domain": "PRODUCT",
        "folder": "NIKET-Q-SMEC-Product",
        "desc": "Product roadmap, milestone tracking",
    },
    {
        "name": "Quantum-Tools",
        "domain": "SCIENCE",
        "folder": "Q-SMEC-Quantum-Tools",
        "desc": "DFT runners, unified_pipeline.py, .venv",
    },
    {
        "name": "Quantum-Tools-Docs",
        "domain": "DOCS",
        "folder": "Q-SMEC-Quantum-Tools-Docs",
        "desc": "Physics parameter docs, DFT guides",
    },
    {
        "name": "Client-Databases",
        "domain": "DATA",
        "folder": "Q-SMEC-Client-Databases",
        "desc": "Client folders, UC data, NDA tracking",
    },
    {
        "name": "Client-Databases-Docs",
        "domain": "DOCS",
        "folder": "Q-SMEC-Client-Databases-Docs",
        "desc": "Client DB docs, white papers",
    },
    {
        "name": "Testing-Workflow-Seq",
        "domain": "TESTING",
        "folder": "Q-SMEC-Testing-Workflow-Sequence",
        "desc": "Test orchestration, workflow sequencing",
    },
    {
        "name": "Testing-Workflow-Docs",
        "domain": "DOCS",
        "folder": "Q-SMEC-Testing-Workflow-Docs",
        "desc": "Test docs, validation procedures",
    },
    {
        "name": "Niket-Work-Documents",
        "domain": "OFFICE",
        "folder": "Niket-Work-Documents",
        "desc": "Business docs, presentations, audits",
    },
    {
        "name": "Computer-Infra-Docs",
        "domain": "INFRA",
        "folder": "Computer-Infrastructure-Docs",
        "desc": "NIKET-HV-01 server docs, setup guides",
    },
    {
        "name": "Agentic-AI-Tools",
        "domain": "AI",
        "folder": "Q-SMEC-Agentic-AI-Tools",
        "desc": "Skills, agents, hooks, MCP configs",
    },
    {"name": "MCP-Server", "domain": "AI", "folder": "Q-SMEC-MCP-Server", "desc": "Custom MCP server, 10+ tools"},
    {
        "name": "Materials-Database",
        "domain": "SCIENCE",
        "folder": "Q-SMEC-Materials-Database",
        "desc": "32-element palette, material properties DB",
    },
    {
        "name": "EW-Sensor-Models",
        "domain": "SCIENCE",
        "folder": "Q-SMEC-EW-Sensor-Models",
        "desc": "EW sensor simulation models",
    },
    {
        "name": "ML-Potentials",
        "domain": "AI",
        "folder": "Q-SMEC-ML-Potentials",
        "desc": "ML interatomic potentials, MACE/NequIP",
    },
    {
        "name": "Benchmarks",
        "domain": "SCIENCE",
        "folder": "Q-SMEC-Benchmarks",
        "desc": "Performance benchmarks, validation suites",
    },
    {
        "name": "Publications",
        "domain": "DOCS",
        "folder": "Q-SMEC-Publications",
