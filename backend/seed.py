...
def _seed_clients(session: Session):
    ...
    clients_data = [
        # Active clients
        {
            "name": "TEP (Tucson Electric Power)",
            "status": "active",
            "type": "client",
            "last_touch": date(2026, 3, 28),
            "uc": ["UC21", "UC22"],
            "data_size": "49.9 MB",
            "nda_status": "signed",
            "priority": "high",
            ...
            "notes": "Infrastructure protection, energy grid hardening",
        },
        {
            "name": "Blue Marble Technologies",
            "status": "active",
            "type": "client",
            "last_touch": date(2026, 4, 2),
            ...
            "contact": "Dan Geraci",
            "sector": "Defense / DE",
            "notes": "Optical warfare, directed energy, C-UAS",
        },
        {
            "name": "Dan Carothers / RAMTDR",
            "status": "active",
            "type": "client",
            ...
            "nda_status": "signed",
            "priority": "medium",
            "contact": "Dan Carothers (dcphotonics)",
            "sector": "Photonics / RF",
            "notes": "InP alternatives, FPA ROIC, optical interconnects",
        },
        {
            "name": "Nikolay / Drone-Laser",
            "status": "active",
            "type": "client",
            "last_touch": date(2026, 3, 25),
            "uc": ["UC17", "UC19"],
            "data_size": "0.3 MB",
            "nda_status": "signed",
            "priority": "medium",
            "contact": "Nikolay",
            "sector": "Defense / C-UAS",
            "notes": "Counter-UAS laser systems",
        },
        # Prospects
        {
            ...
            "status": "prospect",
            "type": "client",
            "last_touch": date(2026, 3, 31),
            "uc": ["UC01", "UC02", "UC04", "UC05", "UC06"],
            "data_size": "0 MB",
            "nda_status": "pending",
            "priority": "high",
            "contact": "Michael Risik",
            "sector": "Defense / EW / DE",
            "notes": "Golden Dome, NAMC RPP, DONRCO DE — 3 active opportunities",
        },
        {
            "name": "Optimal Cities / CII",
            "status": "prospect",
            "type": "client",
            "last_touch": date(2026, 4, 2),
            "uc": ["UC07", "UC21", "UC22"],
            "data_size": "0.3 MB",
            "nda_status": "unsigned (Sept 2025)",
            "priority": "high",
            "contact": "T. Finefrock, Alex Dely",
            "sector": "Energy / Smart City",
        ...
        },
        {
            ...
            "status": "prospect",
            "type": "client",
            "last_touch": date(2026, 3, 20),
            "uc": ["UC10", "UC11", "UC12", "UC13"],
            "data_size": "0.3 MB",
            "nda_status": "pending",
            "priority": "medium",
            "contact": "Direct",
        ...
        # Partners & Research
        {
            ...
            "nda_status": "n/a",
            "priority": "high",
            "contact": "Boulat Bash, Janet Roveda (Board)",
            "sector": "Academic / Quantum",
            "notes": "Quantum research collaboration — active discussions",
        },
        {
            "name": "NBU Bulgaria",
            "status": "active",
            ...
            "nda_status": "n/a",
            "priority": "medium",
            "contact": "Todor Kolarov",
            "sector": "Academic / Defense",
            "notes": "Int'l conference April 23 — Alex presenting CII/NIKET",
        },
        {
            "name": "Blue Ridge Networks",
            "status": "prospect",
            "type": "partner",
            "last_touch": date(2026, 4, 2),
            "uc": ["UC07", "UC21", "UC22"],
            ...
            "nda_status": "pending",
            "priority": "medium",
            "contact": "John Higginbotham",
            "sector": "Cybersecurity",
            "notes": "DragonFly strategic alliance — infrastructure cyber",
        },
        {
        ...
        # Early stage
        {
            ...
            "notes": "Deep underground sensing applications",
        },
        {
            "name": "Green Valley Water Utility",
            "status": "early",
            "type": "client",
            "last_touch": date(2026, 4, 2),
            "uc": ["UC22"],
...
def _seed_pipeline(session: Session):
    ...
    pipeline_data = [
        ...
        {
            "uc": "UC04",
            "name": "MEMS 10-DOF IMU",
            "phase": "Phase 0",
            "status": "research",
            "progress": 50,
            "uc_type": "inertial_sensor",
        },
        {
            "uc": "UC05",
            "name": "1GHz-5THz VCO",
            ...
            "status": "baseline",
            "progress": 65,
            "uc_type": "acoustic_resonator",
        },
        {
            "uc": "UC06",
            "name": "GHz-THz Converter",
            "phase": "Phase 0",
            "status": "research",
            "progress": 30,
            "uc_type": "rf_transceiver",
        },
        {
            "uc": "UC07",
            "name": "Deep Underground Sensor",
            "phase": "Phase 0",
            "status": "research",
            "progress": 55,
            "uc_type": "quantum_sensing",
        },
        {
            "uc": "UC08",
            "name": "Counter-UAS EW Suite",
            "phase": "Phase 0",
            "status": "research",
            "progress": 20,
            "uc_type": "rf_transceiver",
...
def _seed_emails(session: Session):
    ...
    emails_data = [
        {
            "id": "1",
            "from_addr": "adely@cii-international.com",
            "from_name": "Alex Dely",
            "to_addr": "NIKET Team",
            "subject": "Fwd: War gaming in the age of AI",
            "date": datetime(2026, 4, 3),
            "snippet": "War gaming AI research forward — defense strategy relevance",
            "category": "research",
            "uc": None,
            "client": None,
        ...
        {
            "id": "14",
            "from_addr": "boulat@arizona.edu",
            "from_name": "Boulat Bash (U of A)",
            "to_addr": "NIKET Team",
